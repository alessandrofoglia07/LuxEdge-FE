...
const Review: React.FC<Props> = ({ review, modifiable }: Props) => {
            ...
            <div className='flex items-center justify-between'>
                ...
                {modifiable && (
                    <div className='flex items-center'>
                        ...
                        <button className='w-6 h-6 p-2 mx-2 group text-primary-base hover:text-primary-hover'>
                ...
                <div className='mt-12 mb-4'>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <button className='px-4 h-12 bg-primary-base hover:bg-primary-hover rounded-lg text-white font-semibold hover:shadow-xl transition-all'>Confirm</button>
                        </div>
                    </div>
                </div>
            )}
