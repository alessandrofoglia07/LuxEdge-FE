...
const Testimonial: React.FC<Props> = ({ testimonial }: Props) => {
    return (
        <div
            id='Testimonial'
            className='w-96 -lg:w-2/3 h-[26rem] bg-white shadow-xl flex flex-col items-center p-4 hover:transform hover:scale-105 transition-all duration-300 ease-in-out'>
